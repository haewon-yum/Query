...
-- =====================================================================
-- AS-15. target_accessible_supply_spend_score (Spend-based)
-- =====================================================================
target_accessible_supply_spend_score AS (
  SELECT
    campaign_id,
    'target_accessible_supply_spend_score' AS blueprint_index,
...
-- =====================================================================
-- AS-16. traffic_accessible_supply_spend_score (Spend-based)
-- =====================================================================
traffic_accessible_supply_spend_score AS (
  SELECT
    campaign_id,
    'traffic_accessible_supply_spend_score' AS blueprint_index,
...
-- =====================================================================
merged AS (
  SELECT * FROM target_accessible_supply_spend_score
  UNION ALL SELECT * FROM traffic_accessible_supply_spend_score
    ...
    *,
    ...
    ROUND(
      (
        MAX(
          CASE
            WHEN blueprint_index = 'target_accessible_supply_spend_score'
            THEN score
          END
        ...
        *
        MAX(
          CASE
            WHEN blueprint_index = 'traffic_accessible_supply_spend_score'
            THEN score
          END
        ) OVER (PARTITION BY campaign_id)
      ) / 100.0,
      2
    ) AS overall_campaign_spend_score,
