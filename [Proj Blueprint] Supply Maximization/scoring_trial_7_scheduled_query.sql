...
-- BidRequest-based scores only (spend-based scores removed)
-- =====================================================================
...
-- =====================================================================
-- AS-10. Summary table (bidrequest-level only)
-- =====================================================================
summary AS (
  SELECT
    cd.campaign_id,
  ...
  FROM (
    SELECT DISTINCT campaign_id, os, ad_tracking_allowance
    FROM campaign_digest
  ) cd
...
-- =====================================================================
-- AS-11. target_accessible_supply_bidreq_score (BidRequest-based)
-- =====================================================================
...
-- =====================================================================
-- AS-12. traffic_accessible_supply_bidreq_score (BidRequest-based)
-- =====================================================================
    ...
    *,
    ...
    ROUND(
      (
        MAX(
          CASE
            WHEN blueprint_index = '1_target_accessible_supply_bidreq_score'
            THEN score
          END
        ...
        *
        MAX(
          CASE
            WHEN blueprint_index = '2_traffic_accessible_supply_bidreq_score'
            THEN score
          END
        ) OVER (PARTITION BY campaign_id)
      ) / 100.0,
