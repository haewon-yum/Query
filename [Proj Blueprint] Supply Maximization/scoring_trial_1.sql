DECLARE spend_start_date DATE DEFAULT '2025-12-01';
DECLARE spend_end_date   DATE DEFAULT '2025-12-01';
DECLARE analysis_date    STRING DEFAULT '251201';
...
summary AS (
  SELECT
    ...
    mo.tracking_eligible_spend,   -- ✅ renamed from lat_eligible_spend
...
-- target_accessible_supply_score
