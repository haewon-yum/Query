...
Original_json: 
    ...
    "user_capper":{
        "budget":{
            ...
            "all_regions":false,
            "system_targets":["block_advertising_app","media_app"],
    "skadn_input":null,
    "feature_whitelist":{"country_settings":{},"pc_migrated":false,"allow_ctv_tr_links":false},
    "experimental_properties":{
      "restrict_category":[],
      "exclusive_deal_ids":[],
      "extra_app_bundles_for_ctv":[],
      "jio_support":null,
      "hotstar_support":null,
      "allow_reference_common_filters":false,
      "bid_flow_policy":null,
      "daily_budget_windows_tmp":[],
      "dreamgames_support":null,
      "value_based_bidding":null,
      "moloco_next_identifier":false},
    "audience_tags":{},
    "custom_key_values":{},
    "creative_pick":null,
    "ad_tracking_allowance":"NON_LAT_ONLY",
    "timeline":{"liveness_changed_since_ns":"1747051221767295702"},
